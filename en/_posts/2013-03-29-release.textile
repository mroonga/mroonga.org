...
Here is the concrete procedures "how to build from scratch":http://mroonga.org/ja/docs/install.html#install-from-the-source-code-with-mariadb.
...
See "Release 3.02 - 2013/03/29":/docs/news.html#release-3-02 about detailed changes since 3.01.
