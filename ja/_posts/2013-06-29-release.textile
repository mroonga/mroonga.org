...
h3. fast mutexesオプションのカスタマイズをサポート
...
h3. Windows向けMariaDBバンドル版mroongaの提供を開始
...
* "mariadb-10.0.3-with-mroonga-3.05 64bit版":http://packages.groonga.org/windows/mroonga/mariadb-10.0.3-with-mroonga-3.05-winx64.zip

* "mariadb-10.0.3-with-mroonga-3.05 32bit版":http://packages.groonga.org/windows/mroonga/mariadb-10.0.3-with-mroonga-3.05-win32.zip
