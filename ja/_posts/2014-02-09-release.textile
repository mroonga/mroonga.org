...
バージョンごとの "アップグレードガイド":/ja/docs/install.html#upgrade-guide

h3. Mroonga 4.00にいたるまで

Mroonga 4.00をリリースするにあたり、以前のメジャーバージョンである3.00からどんな変更が入ったのかふりかえってみましょう。

* groonga-normalizer-mysqlパッケージで @utf8_unicode_ci@ と @utf8mb4_unicode_ci@ をサポートしました。 (3.01)
...
* "mroonga-action-on-fulltext-query-error":/ja/docs/reference/server_variables.html#mroonga-action-on-fulltext-query-error セッション変数をサポートしました。 (3.06)
...
3.12からの詳細な変更点は "4.00リリース 2014/02/09":/ja/docs/news.html#release-4-00 を確認してください。
